...
<?if($listarPartidasRealizadas != false):?>

<!-- <div class="sportspress sp-widget-align-none"><h4 class="sp-table-caption">Próximas partidas agendadas...</h4> -->
<div class="sp-template sp-template-event-blocks">
	<div class="sp-table-wrapper">
		<table class="sp-event-blocks sp-data-table sp-paginated-table" >
			<thead><tr><th></th></tr></thead> 			<tbody>
			<?foreach ($listarPartidasRealizadas as $key => $v):?>
				<tr class="sp-row sp-post">
					<td>
						...
						size-sportspress-fit-icon wp-post-image" alt=""><br><?=$v->equipe_desafiado;?>
						
						</a>

						<a class="team-logo logo-even" href="#" title="<?=$v->equipe_desafiante;?>">

							<img width="60" height="60" src="<?=$v->logo_desafiante;?>" class="attachment-sportspress-fit-icon size-sportspress-fit-icon wp-post-image" alt="" ><br><?=$v->equipe_desafiante;?>
						...
						<h2 >
							<?=($v->ponto_desafiado == -3) ? 'W.O': $v->ponto_desafiado;?> x <?=($v->ponto_desafiante == -3) ? 'W.O' : $v->ponto_desafiante;?>					
						</h2>
					</td>
				</tr>
			<?endforeach;?>
...
<?else:?>
<div class="sportspress sp-widget-align-none"><h4 class="sp-table-caption">Lista de partidas realizadas...</h4><div class="sp-template sp-template-event-blocks">
	<div class="sp-table-wrapper">
		<table class="sp-event-blocks sp-data-table sp-paginated-table" >
		...
		<tbody>
		<tr>
			<td><h5>Nenhuma partida realizada encontrada.</h5></td>
		</tr>	
